...
%% Step3
p2 = "increase the gap between the flight 2 and the next one";
c2 = Interpreter1(p2,c)
r2 = a.optimize_u(c2);
%draw_optimize_result2("2",a,c2,r2,r1);

%% Step4
p3 = "lower the max height of ip1 on the flight 4";
c3 = Interpreter1(p3,c2)
r3 = a.optimize_u(c3);
%draw_optimize_result2("3",a,c3,r3,r2);

%% Step5
p3 = "increase the gap between the flight 6 and the previous one";
...
xlabel("Step#");ylabel("Alt [ft]")
xticks(turn_s);xticklabels(turn_s)
legend
hold off
%% 相談ループ内での，各フライトへの入力の変化を見る
tau_s = 0:3;
figure
hold on
for i=1:N
    plot(tau_s,h1_table(i,2:end), ...
        DisplayName=num2str(i)+":"+a.name_s(i), ...
        Color=a.color_s(i,:), ...
        LineStyle=":",Marker="o", ...
        LineWidth=2,MarkerSize=9 ...
...
xlabel("相談ループ\tau");ylabel("h_1 [ft]")
xticks(tau_s);xticklabels(tau_s)
legend
hold off